...
export const products: ProductInfo[] = [
    ...
    { id: 1, name: 'Rolex', model: 'Submariner' ,describtion: 'Blue', price: 100000, image: SubmarinerBlue },
    { id: 2, name: 'Rolex', model: 'Air-King' ,describtion: 'Silver', price: 100000, image: AirKing },
    { id: 3, name: 'Rolex', model: 'Submariner' ,describtion: 'Green', price: 100000, image: Submariner }, 
    { id: 4, name: 'Rolex', model: 'Submariner' ,describtion: 'Blue', price: 100000, image: SubmarinerBlue },
    { id: 5, name: 'Rolex', model: 'Air-King' ,describtion: 'Silver', price: 100000, image: AirKing },
]
